...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers( "/userupload").hasAuthority("ADMIN")
                .antMatchers( "/vendorupload").hasAuthority("BUSINESS_OWNER")
                .antMatchers("/upload").hasAnyAuthority("ADMIN","BUSINESS_OWNER")
                .antMatchers("/changePassword", "/resetPassword",  "/images/**", "/css/**", "/js/**", "/vendorDataUploadForm", "/webjars/**")
                .permitAll()
